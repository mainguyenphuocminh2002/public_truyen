...
$("#product_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Truyện");
});
$("#category_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Danh Mục");
});
$("#user_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Thành Viên");
});
$("#roles_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Vai Trò");
});
$("#permissions_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Quyền");
});
$("#publisher_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "NXB");
});
$("#reviews_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Đánh giá");
});
$("#chapters_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Chương Truyện");
});
$("#author_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Tác giả");
});
$("#post_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Bài viết");
});
$("#post_category_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Danh mục");
});
$("#comment_list").on("click", ".delete", function (e) {
  return deleteItem($(this), "Bình luận");
});
