  ...
  <ul class="nav user-menu">
    ...
    <li class="nav-item dropdown has-arrow main-drop">
      <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
        <span class="user-img">
          <img style="height: 40px;width: 40px" src="{{ asset('admin/img/avatar-default.png' ?? $user->avatar) }}" alt="" />
          <span class="status online"></span>
        </span>
        <span><?#= $_SESSION["user"]["username"]; ?></span>
      </a>
      <div class="dropdown-menu">
        <a class="dropdown-item" href="{{route('clients.profile')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
          ...
          Profile</a>
        <a class="dropdown-item" href="{{route('clients.logout')}}"><svg xmlns="http://www.w3.org/2000/svg"
