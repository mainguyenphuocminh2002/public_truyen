...
@section('adminContent')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active">Tạo Quyền</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('permissions.store') }}" id="create_user" enctype="multipart/form-data"
