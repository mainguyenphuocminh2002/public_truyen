                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    {{-- <a href="<?#= SITE_URL ?>/store/product/<?#= $product['id']; ?>"><img
                                                            ...
                                                            src="<?#= SITE_URL ?><?#= $product['thumbnail']; ?> "
                                                            alt="<?#= $product['title']; ?>">
                                                        <span class="title">
                                                            <?#= $product['title']; ?>
                                                        </span>
                                            ...
                                            <td>
                                                ...
                                                <ins class="sizeprice-1">
                                                    <span>
                                                        {{-- <?#= number_format(isset($product["discount"]) ? $product["discount"] : $product["price"], 0, ',', '.') ?>₫ --}}
                                                    </span>
                                                </ins>
                                            </td>
                                            <td class="text-right">
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    <select name="loai" class="select custom-select" required
