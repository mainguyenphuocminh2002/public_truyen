...
@section('adminContent')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form method="POST" action="{{ route('users.store')}}" id="create_user" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="thumbnail-upload">
                                        ...
                                        <div class="thumbnail-preview">
                                            <div id="thumbnailPreview"
                                                style="background-image: url('{{ asset('admin/img/avatar-default.png') }}')">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    @error('roles')
                                        <div class="text-danger text-capitalize">{{ $message }}</div>
                                    @enderror
                                    <select class="select" multiple name="roles[]">
